...
function AddNew({setIsLoading, setIsFail}) {
    ...
    function addStudent(e){
        ...
        console.log(data);
        axios.post("http://localhost:3010/students", data)
            .then(res => {
                setIsLoading(true);
            })
            .catch(err => {
    ...
    return (
        <>
        <button className="btn btn-secondary"  data-bs-toggle="modal" data-bs-target="#addStudent">
        <i className="material-icons">&#xE147;</i> 
        <span>Add New Student</span>
        </button>
    
        <div className="modal fade" id="addStudent" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style={{color: "black"}}>
                ...
                <form onSubmit={(e) => addStudent(e)}>
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="mb-3">
                                <label className="form-label">Is Verified?</label> <br />
                                <label htmlFor="isVerified" className="custom-control custom-radio">Yes</label>
                                <input type="checkbox" value="true" name="isVerified" />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Age</label>
                                <input type="number" className="form-control" min={1} max={100} name="age" />
                            </div>
                        </div>
